...
class SigninProviderCommandOfTest
{
	private static Stream<Arguments> rawInputCases()
	{
		return Stream.of(
							 ...
							 new RawInputCase("blank raw secret", () -> SigninProviderCommand.of("ada@example.com", " ", "local"),
	...
	private record RawInputCase(String description, Supplier<SigninProviderCommand> invocation, Object[] expectedValues)
	{
	}
	...
	class CarrierBehavior
	{
		...
		@MethodSource("de.gupta.security.janus.adapter.provider.SigninProviderCommandOfTest#rawInputCases")
