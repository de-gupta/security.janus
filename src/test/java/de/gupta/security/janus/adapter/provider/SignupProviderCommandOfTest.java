...
class SignupProviderCommandOfTest
{
	...
	private record RawInputCase(String description, Supplier<SignupProviderCommand> invocation, Object[] expectedValues)
	{
	}
	...
	class CarrierBehavior
	{
		...
		@MethodSource("de.gupta.security.janus.adapter.provider.SignupProviderCommandOfTest#rawInputCases")
