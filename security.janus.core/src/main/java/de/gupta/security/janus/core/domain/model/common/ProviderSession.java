                              ...
                              Optional<Instant> expiresAt, Map<String, Object> metadata)
{
	...
	public ProviderSession
	{
		...
		sessionId = sanitizeOptional(sessionId, "sessionId must not be blank");
		accessToken = sanitizeOptional(accessToken, "accessToken must not be blank");
		refreshToken = sanitizeOptional(refreshToken, "refreshToken must not be blank");
		idToken = sanitizeOptional(idToken, "idToken must not be blank");
