...
import de.gupta.security.core.support.TestFixtures;
...
import de.gupta.security.janus.core.domain.model.provider.ProviderSigninFailure;
import de.gupta.security.janus.core.domain.model.provider.ProviderSigninFailureReason;
...
class AuthenticationServiceSigninTest
{
	...
	class Validation
	{
		...
		@MethodSource("invalidCommandCases")
		...
		private static Stream<Arguments> invalidCommandCases()
		{
			return Stream.of(
								 ...
								 new InvalidCommandCase("null raw secret",
										 () -> new SigninCommand("ada@example.com", null, "local")),
								 new InvalidCommandCase("blank raw secret",
										 () -> new SigninCommand("ada@example.com", " ", "local")),
	...
	{
		@ParameterizedTest(name = "{0}")
		@MethodSource("providerFailureCases")
